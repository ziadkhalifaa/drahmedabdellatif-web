      ...
      <div className="hidden lg:flex w-full h-[40px] bg-[var(--primary)] text-white/90 text-xs items-center justify-between px-8 absolute top-0 left-0 right-0 z-50">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <a href="#" className="hover:text-white transition-colors hover:scale-110"><Facebook size={14} /></a>
            <a href="#" className="hover:text-white transition-colors hover:scale-110"><Youtube size={14} /></a>
